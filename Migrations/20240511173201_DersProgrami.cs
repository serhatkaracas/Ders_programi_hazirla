...
{
    /// <inheritdoc />
    public partial class DersProgrami : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KullaniciRoles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BosGun = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rolles", x => x.Code);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SinifID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SinifSeviyesi = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Mevcut = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
